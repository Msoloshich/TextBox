...
<form action="${path}" method="post" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="emal" name="email" value="<#if user??>${user.email}</#if>"
                   class="form-control ${(emailError??)?string('is-invalid', '')}"
                   placeholder="sample@some.com"/>
            <#if emailError??>
                <div class="invalid-feedback">
                    ${emailError}
                </div>
    ...
    <div class="col-sm-6">
        <div class="g-recaptcha" data-sitekey="6LcVdX4UAAAAAGg5GWekAc6ce-u4tZT1urbaSOHY"></div>
        <#if captchaError??>
